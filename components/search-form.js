...
export default function SearchForm(props) {
  ...
  return (
    <div className={`pl-4 h-12 bg-white flex ${className}`}>
      ...
      <Button onClick={search} className="rounded-r-sm transition ease-in-out 400 bg-green-600 hover:bg-green-700 text-white text-lg" >
